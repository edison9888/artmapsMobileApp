...
NSString* const SERVER_CONTEXT_URL_FORMAT = @"http://artmapsv2.cloudapp.net/service/%@/rest/v1";
//NSString* const SERVICES_CONTEX =  @"tate";
//NSString* const SERVICES_CONTEX =  @"glatm";

...
+(OoIMetaGLA*)getOoIMetaGLAFromDictionary:(NSDictionary*)dict{
    OoIMetaGLA* meta = [[OoIMetaGLA alloc] init];
    meta.allegiance = [dict objectForKey:@"Allegiance"];
    meta.event = [dict objectForKey:@"Event"];
    meta.name = [dict objectForKey:@"Name"];
    meta.year = [dict objectForKey:@"Year"];
    //meta.reference = [dict objectForKey:@"reference"];
    //meta.title = [dict objectForKey:@"title"];
    return [meta autorelease];
}
